...
print('most_similar(positive=[''красивый'', ''уродливый''])')
print()
print('model1: not sg, window = 2')
print(*model1.wv.most_similar(positive=['красивый', 'уродливый']), sep='\n')
print()
print('model2: not sg, window = 5')
print(*model2.wv.most_similar(positive=['красивый', 'уродливый']), sep='\n')
print()
print('model3: not sg, window = 10')
print(*model3.wv.most_similar(positive=['красивый', 'уродливый']), sep='\n')
print()
print('model4: sg = 1, window = 10')
print(*model4.wv.most_similar(positive=['красивый', 'уродливый']), sep='\n')
print()
print('model5: sg = 1, window = 2')
print(*model5.wv.most_similar(positive=['красивый', 'уродливый']), sep='\n')
print()
print('model6: sg = 1, window = 5')
print(*model6.wv.most_similar(positive=['красивый', 'уродливый']), sep='\n')
